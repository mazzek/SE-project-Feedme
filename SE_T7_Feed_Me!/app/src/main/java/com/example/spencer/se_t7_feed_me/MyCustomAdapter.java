...
public class MyCustomAdapter extends BaseAdapter implements ListAdapter{
    ...
    private ArrayList<String> RestaurantsFavBool = new ArrayList<String>();
    private ArrayList<String> RestaurantsId = new ArrayList<String>();
    private String username;
    private String pass;
    private Context context;

    public MyCustomAdapter(String username, String pass, ArrayList<String> RestaurantsName, ArrayList<String> RestaurantsAddress, ArrayList<String>RestaurantsFavBool,ArrayList<String>RestaurantsId, Context context) {
        this.RestaurantsName = RestaurantsName;
        this.RestaurantsAddress = RestaurantsAddress;
        this.RestaurantsFavBool = RestaurantsFavBool;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(RestaurantsFavBool.get(position).equals("1"))
        {
            favoriteText.setText("Favorited");
            //   favoriteText.setVisibility(View.VISIBLE);
            // favoriteButton.setVisibility(View.INVISIBLE);
        }
        if(RestaurantsFavBool.get(position).equals("0"))
        {
            favoriteText.setText("Not favorited");
        }
        favoriteText.setVisibility(View.VISIBLE);
        /*else
        {
    ...
    class connect extends AsyncTask<Integer, String, Void>
    {
        ...
        protected Void doInBackground(Integer... params) {
            String url_select = "http://feedmedb.netne.net/add.php";
